...
let questions = { 
    os: [ 
        ...
        {q:"Linux is a _ ", o:["OS","Database","Network","Compiler"], a:1}, 
        {q:"Process means?", o:["Program in execution","File","Disk","Memory"], a:1}, 
        {q:"Kernel is?", o:["Hardware","Core of OS","Browser","App"], a:2}, 
        {q:"Deadlock condition?", o:["No memory","Waiting forever","Virus","Shutdown"], 
a:2}, 
        {q:"Booting means?", o:["Start computer","Stop computer","Install OS","Format disk"], 
a:1}, 
        {q:"GUI stands for?", o:["Graphical User Interface","General Utility Input","Graphical 
User Instruction","None"], a:1}, 
        {q:"Unix is written in?", o:["C","Java","Python","Assembly"], a:1}, 
        {q:"Which is not type of OS?", o:["Batch","Time sharing","Distributed","Compiler"], 
a:4}, 
        {q:"Virtual memory is?", o:["Extra RAM","Memory on disk","ROM","Cache"], a:2}, 
        {q:"OS manages?", o:["Hardware","Software","Both","None"], a:3}, 
        {q:"Round robin is?", o:["Scheduling algorithm","Memory management","Device 
driver","File system"], a:1}, 
        {q:"Semaphore used for?", o:["Synchronization","Compiling","Browsing","Printing"], 
a:1}, 
        {q:"Fragmentation refers to?", o:["Memory waste","CPU busy","Keyboard 
issue","None"], a:1}, 
        ...
        {q:"Swapping is?", o:["Switching processes","Printing data","Running OS","None"], 
a:1}, 
    ...
    science: [ 
        ...
        {q:"Gas in air?", o:["O2","CO2","N2","All"], a:4}, 
        ...
        {q:"Acid in stomach?", o:["HCl","H2SO4","HNO3","CO2"], a:1}, 
    ...
    ds: [ 
        ...
        {q:"DFS stands for?", o:["Depth First Search","Data File System","Disk 
Format","None"], a:1}, 
        {q:"BFS stands for?", o:["Breadth First Search","Binary Full Search","Block 
File","None"], a:1}, 
...
function selectOption(option) { 
    if(option === questions[selectedSubject][index].a) score++; 
    nextQuestion(); 
} 
...
function nextQuestion() { 
    ...
    if(index >= questions[selectedSubject].length) submitQuiz();  
    else loadQuestion(); 
} 
